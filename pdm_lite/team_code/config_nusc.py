...
class GlobalConfigNusc:
    ...
    def __init__(self):
        ...
        self.distance_for_walker_speed = 0.25  # set that dynamically later
        ...
        self.idm_stop_sign_minimum_distance = 1.0
        ...
        self.idm_pedestrian_minimum_distance = 1.0
        ...
        self.lidar_pos = [0.0, 0.0, 2.25]  # x, y, z mounting position of the LiDAR
        ...
        # Semantic LIDAR
        self.semantic_lidar_pos = [0.0, 0.0, 2.25]  # x, y, z mounting position of the LiDAR
