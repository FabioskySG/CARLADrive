...
class DataAgent(AutoPilot):
    ...
    def _init(self, hd_map):
        super()._init(hd_map)
        # if self.datagen: # I want datagen to be consistent
    ...
    def run_step(self, input_data, timestamp, sensors=None, plant=False):
        ...
        # Basic PDM Lite converts LiDAR into the coordinate frame of the ego vehicle.
        ...
        pedestrians_removed = CarlaDataProvider.update_pedestrian_cleanup()
        if self.step_tmp == 1: # For generating pedestrians in the first cycle
            pedestrians_removed = True
        CarlaDataProvider.spawn_pedestrians_on_sidewalks(pedestrians_removed)
    ...
    def save_sensors(self, tick_data):
        ...
        print(f"Vehicle transform when saving lidar: {self._vehicle.get_transform()}")
